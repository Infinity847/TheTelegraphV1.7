...
let ask = prompt(`
There is only one rule for the app.
1. Do not hack the server

I do not care about anything that happens in this app.
Do not complain to me about this. I don't want new rules. I mean it.
If someone hacks the server I will
shut down the app for everyone.
